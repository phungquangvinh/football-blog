...
<div class="footer-menu">
	...
	<div class="dichvuchinh">
		<h3>TIN TỨC</h3>
        <ul>
            <?php while ($row2 = mysqli_fetch_array($dkm)){
	...
	<div class="chinhsach">
		...
		<ul>
			...
			<li style="margin-top: 10px;"><a href="#">Vào forum</a></li>
...
<div class="end">
	...
	<p>&copy 2014 Store. All Rights Reserved. Designer by<a href="http://gmail.com" style="color: #0395f0"> hththeme@gmail.com</a></p>
</div>